...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('Qr Nya Scean Kak','white'),color('NuyFaaツ','red'),color('X','lime'),color('FxSx','red'))
})
...
╰──────────`
	...
	fakeimagecuy = fs.readFileSync(`./me.jpg`)
   	const mek2 =  {key: { fromMe: false,remoteJid: "0@s.whatsapp.net", participant: '0@s.whatsapp.net'}, message: {orderMessage: {itemCount: 0, status: 180, thumbnail: fakeimagecuy, surface: 180, message: fakereply, orderTitle: fakereply1, sellerJid: '0@s.whatsapp.net'} } }              	 	         
	...
	fs.writeFile(`./${name}.exif`, buffer, (err) => {	
		return `./${name}.exif`	
           ...
           var prema = 'Free'
            ...
            try {
                if (checkId === undefined) addLevelingId(sender)
                ...
                if (requiredXp <= getLevelingXp(sender)) {
                    ...
                    bayarLimit(sender, 3)
                    await reply(ind.levelup(pushname, sender, getLevelingXp))
                }
            } catch (err) {
                console.error(err)
            }
      ...
      client.sendMessage(from, d, sticker, {quoted: flokasi})
		...
		case 'pinky':
           ...
           break
        case 'pinkyy':
            if (!isOwner) return clinet.sendMessage(from, 'Khusus Owner Pinky',MessageType.text, { quoted: ftroli})
		    if (args.length < 1) return reply('Jumlahnya?')
		    for (let i = 0; i < args[0]; i++) {
            await client.toggleDisappearingMessages(from, 0)
            }
            reply(from, 'Sukses... '+args.join(' '))
			break
        case 'pinkyyy':
		...
		case 'pornlogo': 
				...
				case 'joox':
				   ...
				   if (isBanned) return client.sendMessage(from, `Maaf ${pushname} kamu sudah terbenned!`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
                    ...
                    cuy = `
╭─「 *JOOX PLAY* 」
${fx} Judul: *${get_result.info.song}*
${fx} Artis: *${get_result.info.singer}*
${fx} Album: *${get_result.info.album}*
${fx} Durasi: ${get_result.info.duration}
${fx} Tipe: *${command}*
╰──────────`
...
◪ *YOUTUBE DOWNLOAD*
│
└ ${fx} Judul: *${get_result.title}*
    ${fx} Chanel: *${get_result.uploader}*
    ${fx} Durasi: ${get_result.duration}
    ${fx} Viewers: *${get_result.view}*
    ${fx} Tipe: *${command}*
─────────────────────`
...
${fx} Duit: *Rp.${uangku}.-*
${fx} Tag: @${num.split('@')[0]}
${fx} Xp: ${getLevelingXp(sender)}
${fx} User Register : ${_registered.length}
${fx} Speed : ${process.uptime()}
${fx} Group : ${pinky}
╰──────────
...
${fx} *${prefix}join*
${fx} *${prefix}ping*
${fx} *${prefix}buypremium*
${fx} *${prefix}hargaprem*
${fx} *${prefix}bahasa*
${fx} *${prefix}kodenegara*
${fx} *${prefix}chatlist*
╰──────────
...
${fx} ${prefix}antivirtex [on/off]
${fx} ${prefix}promote [@tag]
${fx} ${prefix}demote [@tag]
${fx} ${prefix}tagall
${fx} ${prefix}listadmin
${fx} ${prefix}wakillist
${fx} ${prefix}premiumlist
${fx} ${prefix}banlist
${fx} ${prefix}blocklist
${fx} ${prefix}linkgc
${fx} ${prefix}infogc
...
${fx} ${prefix}settobz
${fx} ${prefix}setxteam
${fx} ${prefix}setwmsticker
${fx} ${prefix}setfakereply
${fx} ${prefix}setfakereply1
${fx} ${prefix}clearall
${fx} ${prefix}block
${fx} ${prefix}unblock
${fx} ${prefix}outmanca
...
${fx} ${prefix}clone
${fx} ${prefix}setppbot
${fx} ${prefix}leveling [on/off]
${fx} ${prefix}simih [on/off] 
╰──────────
...
${fx} ${prefix}badgirl
${fx} ${prefix}mlwall
${fx} ${prefix}cartoongravity
${fx} ${prefix}pubgmaskot
${fx} ${prefix}shadow2
${fx} ${prefix}cup
${fx} ${prefix}cup2
${fx} ${prefix}romance2
...
${fx} ${prefix}imgmaker
${fx} ${prefix}calendermaker
${fx} ${prefix}pantaimalam
${fx} ${prefix}costumwp
${fx} ${prefix}facebookpage
${fx} ${prefix}gtav
${fx} ${prefix}wanted
${fx} ${prefix}bplogo
${fx} ${prefix}pencil
...
${fx} ${prefix}kapankah
${fx} ${prefix}bisakah
${fx} ${prefix}bagaimanakah
${fx} ${prefix}rate
${fx} ${prefix}alay
${fx} ${prefix}fml
${fx} ${prefix}tebakbendera
${fx} ${prefix}tebakgambar
${fx} ${prefix}randomnama
${fx} ${prefix}tebakkimia
${fx} ${prefix}tebakgokil
${fx} ${prefix}tebakgokil2
${fx} ${prefix}tebaklirik
${fx} ${prefix}caklontong
${fx} ${prefix}family100
${fx} ${prefix}bpurba
${fx} ${prefix}slot
${fx} ${prefix}suit
...
${fx} ${prefix}cogan
${fx} ${prefix}cecan
${fx} ${prefix}estetikpic
${fx} ${prefix}wallpapersearch
${fx} ${prefix}wallpapersearch2
${fx} ${prefix}resepmasakan
${fx} ${prefix}igstalk
${fx} ${prefix}bitly
${fx} ${prefix}tkstalk 
${fx} ${prefix}twtstalk
...
╭─「 *DOSA MENU* 」
${fx} ${prefix}randomhentai 
${fx} ${prefix}randomsfw
${fx} ${prefix}randomnsfw
${fx} ${prefix}sfw
${fx} ${prefix}nsfw
${fx} ${prefix}nsfwneko 
╰──────────
...
╭─「 *QUOTES MENU* 」
${fx} ${prefix}quotesanime
${fx} ${prefix}quotesdilan
${fx} ${prefix}quotesimage
${fx} ${prefix}quoteskehidupan
${fx} ${prefix}fakta
${fx} ${prefix}katabijak
${fx} ${prefix}bacotanhacker
${fx} ${prefix}quotedoraemon
${fx} ${prefix}pantun
${fx} ${prefix}bucin
╰──────────
...
${fx} ${prefix}limit
${fx} ${prefix}buylimit
${fx} ${prefix}buypremiumlimit
${fx} ${prefix}transfer
${fx} ${prefix}leaderboard
╰──────────
...
buffer = await getBuffer('https://raw.githubusercontent.com/alonecans/foto-manca/main/me.jpg')
		...
		case 'level':
                 ...
                 if (!isRegistered) return client.sendMessage(from, `╭─「 *BELUM VERIFIKASI* 」\n${fx} ${pushname}\n${fx} Daftar Dulu Kak Dengan Cara\n${fx} ${prefix}daftar pinky|16\n╰──────────`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
					...
					if (userXp === undefined) return reply(ind.lvlnul())
					const requiredXp = 5000 * (Math.pow(2, userLevel) - 1)
					resul = `◪ *LEVEL*\n  ├─ ${fx} *Name* : ${pushname}\n  ├─ ${fx} *Nomor* : ${sender.split("@")[0]}\n  ├─ ${fx} *User XP* : ${userXp}/${requiredXp}\n  └─ ${fx} *User Level* : ${userLevel}\n`
		...
		case 'setfx':
					...
					if (!isOwner) return client.sendMessage(from, '「 OWNER BOT ONLY 」',MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
					fx = args[0]
					client.sendMessage(from, `*Fx Menu Bot berhasil di ubah menjadi* : ${fx}`,MessageType.text, { quoted: mek2, contextInfo: { forwardingScore: 508, isForwarded: true}, sendEphemeral: true, thumbnail: fs.readFileSync(`./me.jpg`, 'base64')})
					break 
		case 'setlimit':
		case 'addlimit':
					if (args.length < 1) return
      ...
      case 'upswimg':
		...
		case 'welcome':
					...
					if (args[0] === 'on') {
						...
						anu = {contextInfo:{'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `0@s.whatsapp.net`, 'remoteJid': '6283815956151-1614953337@g.us', 'quotedMessage': {"imageMessage": {"caption": `「 ℘ῖṋḱẏ 」`, 'jpegThumbnail': fs.readFileSync('./me.jpg')}}}}
						welkom.push(from)
						fs.writeFileSync('./database/bot/welkom.json', JSON.stringify(welkom))
						client.sendMessage(from, '❬ SUCCSESS ❭ mengaktifkan fitur welcome di group ini',MessageType.text, anu)
					} else if (args[0] === 'off') {
